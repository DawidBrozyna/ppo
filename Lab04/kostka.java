    ...
    private void run() {
        ...
        while (!gameEnded) {
            for (Player player : players) {
                ...
                System.out.println(player.getName() + " rolled " + result + ". Now is on position " + position + ".");
                ...
                if (position % 7 == 0) {
                    ...
                    System.out.println(player.getName() + " rolled " + damage + " on the 7's field. Health remaining: " + player.getHealth() + ".");
                    if (player.getHealth() <= 0) {
                        System.out.println(player.getName() + " lost all health and is out of the game!");
